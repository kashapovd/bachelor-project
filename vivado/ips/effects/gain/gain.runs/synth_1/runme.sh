...
HD_PWD='C:/Users/yaroslav/Desktop/bachelor-project/vivado/ips/effects/gain/gain.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gain.tcl
