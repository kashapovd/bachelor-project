...
HD_PWD='C:/Users/yaroslav/Desktop/bachelor-project/vivado/ips/effects/overdrive/overdrive.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log overdrive.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source overdrive.tcl
