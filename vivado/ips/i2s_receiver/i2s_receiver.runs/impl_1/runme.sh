...
HD_PWD='C:/Users/yaroslav/Desktop/bachelor-project/vivado/ips/i2s_receiver/i2s_receiver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2s_receiver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2s_receiver.tcl -notrace
