...
HD_PWD='C:/Users/yaroslav/Desktop/bachelor-project/vivado/ips/i2s_receiver/i2s_receiver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2s_receiver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2s_receiver.tcl
