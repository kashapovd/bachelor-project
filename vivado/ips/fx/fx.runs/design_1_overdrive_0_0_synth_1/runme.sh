...
HD_PWD='C:/Users/yaroslav/Desktop/bachelor-project/vivado/ips/fx/fx.runs/design_1_overdrive_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_overdrive_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_overdrive_0_0.tcl
