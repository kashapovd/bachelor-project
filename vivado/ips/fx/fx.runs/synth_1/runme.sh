...
HD_PWD='C:/Users/yaroslav/Desktop/bachelor-project/vivado/ips/fx/fx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fx.tcl
