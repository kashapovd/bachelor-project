...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../fx-processor.gen/sources_1/bd/design_1/ipshared/6dcf" \
       +incdir+"$ref_dir/../../../../fx-processor.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../fx-processor.gen/sources_1/bd/design_1/ipshared/f42d/hdl" \
       +incdir+"../../../../fx-processor.gen/sources_1/bd/design_1/ipshared/6dcf" \
       +incdir+"../../../../fx-processor.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../fx-processor.gen/sources_1/bd/design_1/ipshared/f42d/hdl" \
       +incdir+"D:/Xilinx/Vivado/2021.1/data/xilinx_vip/include"
}
