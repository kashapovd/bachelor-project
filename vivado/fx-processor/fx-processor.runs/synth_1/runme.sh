...
HD_PWD='C:/Users/yaroslav/Desktop/bachelor-project/vivado/fx-processor/fx-processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fx_processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fx_processor.tcl
