...
HD_PWD='C:/Users/yaroslav/Desktop/bachelor-project/vivado/fx-processor/fx-processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fx_processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fx_processor.tcl -notrace
